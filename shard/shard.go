// Package shard ports DatoriumDB document sharding helpers
// (CRC32 of the sharding prefix → 8-bit slot).
package shard
...
// sharding prefix. Periods in the first six rune positions are ignored for
...
// CRC32 with no document-ID prefix detection. Search result shards use this.
